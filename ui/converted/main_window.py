...
# Form implementation generated from reading ui file 'raw/main_window.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphWidget = GraphWidget(self.tab)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 923, 857))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Назначение целей"))
        self.label_4.setText(_translate("MainWindow", "Размер популяции:"))
        self.label_5.setText(_translate("MainWindow", "Коэффициент Ci:"))
        self.label_6.setText(_translate("MainWindow", "Итераций:"))
        self.immuneNp.setText(_translate("MainWindow", "10"))
        self.immuneCi.setText(_translate("MainWindow", "2.8"))
        self.immuneNi.setText(_translate("MainWindow", "300"))
        self.immuneButton.setText(_translate("MainWindow", "Выполнить"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_3), _translate("MainWindow", "Иммунный"))
        self.label_7.setText(_translate("MainWindow", "Размер популяции:"))
        self.gaNp.setText(_translate("MainWindow", "10"))
        self.label_8.setText(_translate("MainWindow", "Вероятность мутации:"))
        self.gaMp.setText(_translate("MainWindow", "0.19"))
        self.gaNi.setText(_translate("MainWindow", "300"))
        self.gaButton.setText(_translate("MainWindow", "Выполнить"))
        self.evolutionBox.setItemText(0, _translate("MainWindow", "Эволюция Дарвина"))
        self.evolutionBox.setItemText(1, _translate("MainWindow", "Эволюция Де Фриза"))
        self.label_9.setText(_translate("MainWindow", "Итераций:"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_5), _translate("MainWindow", "Генетический"))
        self.groupBox.setTitle(_translate("MainWindow", "Результат поиска"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Основное"))
        self.label_3.setText(_translate("MainWindow", "Цели и их значимость"))
        self.addTargetButton.setText(_translate("MainWindow", "Добавить"))
        self.deleteTargetButton.setText(_translate("MainWindow", "Удалить"))
        self.label_2.setText(_translate("MainWindow", "Типы исполнителей и их количество"))
        self.addWeaponButton.setText(_translate("MainWindow", "Добавить"))
        self.deleteWeaponButton.setText(_translate("MainWindow", "Удалить"))
        self.label.setText(_translate("MainWindow", "Вероятности"))
        self.saveIntoFileButton.setText(_translate("MainWindow", "Сохранить условия в файл..."))
        self.loadFromFileButton.setText(_translate("MainWindow", "Загрузить условия из файла..."))
        self.generateButton.setText(_translate("MainWindow", "Сгенерировать..."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Условия задачи"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "Матрица назначений"))
from ui.src.graphwidget import GraphWidget
